package com.pgzxc.poplive.widget;
...
public class LiveDialog extends AlertDialog implements OnClickListener {
    ...
    private void initView() {
        ...
        view.findViewById(R.id.rl_radio).setOnClickListener(this);
        view.findViewById(R.id.rl_small_video).setOnClickListener(this);
